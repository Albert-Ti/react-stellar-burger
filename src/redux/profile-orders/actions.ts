...
export const profileOrderConnect = createAction<string | undefined, 'PROFILE_ORDER_CONNECT'>(
...
export const profileOrderWsOpen = createAction<void, 'PROFILE_ORDER_WS_OPEN'>('PROFILE_ORDER_WS_OPEN')
export const profileOrderWsClose = createAction<void, 'PROFILE_ORDER_WS_CLOSE'>('PROFILE_ORDER_WS_CLOSE')
export const profileOrderWsError = createAction<void, 'PROFILE_ORDER_WS_ERROR'>('PROFILE_ORDER_WS_ERROR')
